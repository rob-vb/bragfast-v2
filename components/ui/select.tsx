  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon
        render={<ChevronDownIcon className="pointer-events-none size-4 text-berry/55" />}
      />
    </SelectPrimitive.Trigger>
  );
}
...
export function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-default items-center gap-2 py-1.5 pr-8 pl-3 text-sm font-bold outline-none select-none",
