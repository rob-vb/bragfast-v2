export const nlMessages = {
  ...
  magicLinkSent: "Check je inbox. Als de mail niet aankomt, kijk in spam.",
  or: "of",
...
export const enMessages = {
  ...
  magicLinkSent: "Check your inbox. If it is missing, look in spam.",
  or: "or",
